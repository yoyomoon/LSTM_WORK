...
X_train, labels_train, list_ch_train = read_data(data_path="/home/yoyomoon/PycharmProjects/LSTM_work/data/", split="train") # train
X_test, labels_test, list_ch_test = read_data(data_path="/home/yoyomoon/PycharmProjects/LSTM_work/data/", split="test") # test
